...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Feeder') }} &mdash; Feeds</title>
    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC] min-h-screen antialiased">
        <div class="mx-auto max-w-6xl px-6 py-10 lg:py-16">
            ...
            @else
                <div class="max-h-[calc(100vh-12rem)] overflow-auto rounded-lg border border-[#19140035] dark:border-[#3E3E3A] bg-white dark:bg-[#161615] shadow-sm">
